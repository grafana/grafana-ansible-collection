        ...
        if result.status_code == 202:
            ...
            for contact_points in result.json():
                if contact_points['uid'] == module.params['uid']:
                    if contact_points['name'] == module.params['name'] and contact_points['type'] == module.params['type'] and contact_points['setting'] == module.params['settings'] and contact_points['disableResolveMessage'] == module.params['disableResolveMessage']:
