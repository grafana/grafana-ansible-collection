...
def test_pyroscope_memberlist_config(host):
    ...
    assert "advertise_addr:" in config_file.content_string
    assert "advertise_port: 7946" in config_file.content_string
    assert "join_members:" in config_file.content_string
