...
| `grafana_apt_repo` | deb [arch={{ grafana_apt_arch }} signed-by=/usr/share/keyrings/grafana.asc] {{ grafana_apt_repo_uri }} {{ grafana_apt_release_channel }} main | Apt repository string |
| `grafana_apt_repo_uri` | https://apt.grafana.com/ | URI to the apt repository |
| `grafana_apt_key` | https://apt.grafana.com/gpg.key | Apt repository gpg key |
| `grafana_apt_name` | grafana | name/filename to be used for deb822 file |
